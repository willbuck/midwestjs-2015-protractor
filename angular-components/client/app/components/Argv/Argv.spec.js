...
import {ArgvController} from './Argv.controller';
...
describe('Argv', ()=>{
  ...
  beforeEach(window.module(Argv.name));
  beforeEach(inject((_$rootScope_)=>{
    $rootScope = _$rootScope_;
    makeController = ()=>{
      return new ArgvController();
    };
  }));
  ...
  describe('Directive', ()=>{
      ...
      it('should use the right controller', ()=>{
        expect(directive.controller).to.equal(ArgvController);
      });
  });
});
